...
<div class="container-fluid px-4 py-5" style="min-height: 100vh;">
    ...
    <div class="container">
        <div class="text-center mb-4">
            ...
            <p class="text-secondary fs-5 mx-auto" style="max-width:700px;">
                A top-rated treatment chosen by our customers.
            </p>
        </div>
                    ...
                    <div class="card rounded-5 shadow border-0 h-100 service-card modern-card">
                        ...
                        <div class="card-body text-center px-4 py-4">
                            ...
                            <div class="d-flex justify-content-center align-items-center gap-2 mb-2">
                                {{-- average stars --}}
                                @for($i=1;$i<=5;$i++)
                                    <i class="bi {{ $i <= round($featuredService->average_rating) ? 'bi-star-fill text-warning' : 'bi-star text-muted' }}"></i>
                                @endfor
                                <small class="text-muted">({{ number_format($featuredService->average_rating,1) }})</small>
                            </div>
   ...
   onmouseout="this.style.background='linear-gradient(90deg,#caa974,#d4a373)'">
    View Service
            ...
            @else
                <p class="text-center text-muted">No featured service yet — check back soon!</p>
            @endif
        </div>
    </div>
</div>
...
<style>
    ...
    .modern-card img:hover{transform:scale(1.1);}
</style>
@endpush
@endsection