...
<div class="container py-5">
    <h2 class="fw-bold text-center mb-2" style="letter-spacing: 1.2px; color: #4b4b4b;">Available Services</h2>
    <p class="text-center text-secondary mb-5 fs-6">Select a service and schedule your appointment.</p>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100 border-0 shadow-sm rounded-4 hover-shadow" style="transition: transform 0.3s ease;">
                {{-- Service Image --}}
                @if($service->image)
                ...
                <div class="card-body text-center px-3 py-2">
                    ...
                    <h5 class="card-title fw-semibold mb-1 fs-6" style="color: #343a40;">{{ $service->name }}</h5>
                    ...
                    @else
                    <a href="{{ route('services.book', $service->id) }}" class="btn btn-primary w-100 fw-semibold py-1" style="background: #d4a373; border: none; font-size: 0.9rem; transition: background 0.3s;">
                        Book This Service
                    </a>
                    @endif
                    ...
                    <div class="d-flex flex-column gap-2 mt-2">
                        {{-- Edit Button --}}
                       <a href="{{ route('services.edit', $service->id) }}" class="btn w-100 fw-semibold py-1" style="background-color: #28a745; color: white; font-size: 0.9rem;">
                        Edit
                       </a>
